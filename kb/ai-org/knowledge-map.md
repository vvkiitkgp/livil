...
|---|---|---|---|---|
| `ai-org/knowledge-map.md` | chief-architect | DS, CA | 2026-09-21 | 9999d |
| `architecture/data-model.md` | principal-data | P-DA, BE, QA, DC | 2026-09-21 | 9999d |
| `architecture/inventory.md` | principal-client | ALL | 2026-09-21 | 9999d |
| `architecture/rpc-reference.md` 🔒 | principal-data | P-DA, P-SE, SR, BE | 2026-09-21 | 9999d |
