...
| `architecture/data-model.md` | principal-data | P-DA, BE, QA, DC | 2026-08-12 | 9999d |
| `architecture/inventory.md` | principal-client | ALL | 2026-08-12 | 9999d |
| `architecture/rpc-reference.md` 🔒 | principal-data | P-DA, P-SE, SR, BE | 2026-08-12 | 9999d |
| `security/rls-policies.md` 🔒 | principal-security | P-SE, SR, P-DA, QA | 2026-08-12 | 9999d |
